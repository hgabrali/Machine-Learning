...
**Isolation Forest**, **özyinelemeli bölme (recursive partitioning)** yoluyla aykırı değerleri (outliers) hızla izole etmek için tasarlanmış, **ağaç tabanlı (tree-based)** bir algoritmadır.
