...
Önümüzdeki derslerde bu modellerden bazılarına derinlemesine dalacağız:

* Bu algoritmaların **nasıl çalıştığı**.
* Onları **nasıl eğiteceğimiz ve değerlendireceğimiz**.
* **Avantajları ve dezavantajları**.
* Gerçek dünya problemlerinde **ne zaman kullanacağımız**.
